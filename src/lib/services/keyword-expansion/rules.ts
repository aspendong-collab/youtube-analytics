...
const LANGUAGE_RULE_TEMPLATES: Record<SupportedLanguage, Record<KeywordDimension, string[]>> = {
  'en': {
    scenario: [
      ...
      '{keyword} in 2024', '{keyword} in 2025', '{keyword} latest version', '{keyword} updated',
      '{keyword} for content creation', '{keyword} for marketing', '{keyword} for sales',
      '{keyword} for teachers', '{keyword} for parents', '{keyword} for kids',
      '{keyword} for small business', '{keyword} for startups', '{keyword} for enterprises',
      '{keyword} for remote work', '{keyword} for online learning', '{keyword} for freelancers',
      '{keyword} for personal use', '{keyword} for team collaboration', '{keyword} for project management',
      '{keyword} for data analysis', '{keyword} for research', '{keyword} for presentations',
      '{keyword} for social media', '{keyword} for SEO', '{keyword} for email marketing',
    ],
    carrier: [
      ...
      '{keyword} plugin', '{keyword} addon', '{keyword} integration', '{keyword} API',
      '{keyword} for Chrome', '{keyword} for Firefox', '{keyword} for Safari', '{keyword} for Edge',
      '{keyword} for iOS', '{keyword} for Android Tablet', '{keyword} for Windows Phone',
      '{keyword} online', '{keyword} offline', '{keyword} cloud-based', '{keyword} self-hosted',
      '{keyword} SaaS', '{keyword} open-source', '{keyword} freeware', '{keyword} shareware',
    ],
    state: [
      ...
      '{keyword} trial', '{keyword} demo', '{keyword} full version', '{keyword} cracked',
      '{keyword} safe', '{keyword} legit', '{keyword} worth it', '{keyword} value for money',
      '{keyword} easy to use', '{keyword} beginner-friendly', '{keyword} powerful', '{keyword} efficient',
      '{keyword} reliable', '{keyword} fast', '{keyword} secure', '{keyword} private',
    ],
    goal: [
      ...
      '{keyword} for time management', '{keyword} for project planning', '{keyword} for task tracking',
      '{keyword} for data storage', '{keyword} for file sharing', '{keyword} for communication',
      '{keyword} for creativity', '{keyword} for inspiration', '{keyword} for brainstorming',
      '{keyword} for decision making', '{keyword} for research', '{keyword} for analysis',
      '{keyword} for reporting', '{keyword} for documentation', '{keyword} for knowledge management',
      '{keyword} for team building', '{keyword} for customer service', '{keyword} for sales automation',
    ],
    method: [
      ...
      '{keyword} installation', '{keyword} setup', '{keyword} configuration', '{keyword} customization',
      '{keyword} optimization', '{keyword} troubleshooting', '{keyword} best practices', '{keyword} examples',
      '{keyword} templates', '{keyword} shortcuts', '{keyword} hotkeys', '{keyword} features',
      '{keyword} comparison', '{keyword} alternatives', '{keyword} vs competitors', '{keyword} review',
      '{keyword} masterclass', '{keyword} crash course', '{keyword} bootcamp', '{keyword} certification',
    ],
  },
  'zh-CN': {
    scenario: [
      ...
      '{keyword}在2024年', '{keyword}在2025年', '{keyword}最新版本', '{keyword}更新版',
      '{keyword}做内容创作', '{keyword}做营销', '{keyword}做销售', '{keyword}做推广',
      '{keyword}老师用', '{keyword}家长用', '{keyword}孩子用', '{keyword}全家用',
      '{keyword}创业用', '{keyword}副业用', '{keyword}兼职用', '{keyword}全职用',
      '{keyword}远程办公', '{keyword}在线学习', '{keyword}自由职业', '{keyword}团队协作',
      '{keyword}数据分析', '{keyword}科研用', '{keyword}演示用', '{keyword}汇报用',
      '{keyword}社交媒体', '{keyword}SEO优化', '{keyword}邮件营销', '{keyword}内容营销',
      '{keyword}项目管理', '{keyword}任务管理', '{keyword}时间管理', '{keyword}知识管理',
    ],
    carrier: [
      ...
      '{keyword}扩展', '{keyword}插件', '{keyword}集成', '{keyword}接口',
      '{keyword}浏览器', '{keyword}客户端', '{keyword}在线版', '{keyword}离线版',
      '{keyword}云平台', '{keyword}私有部署', '{keyword}SaaS', '{keyword}开源',
      '{keyword}免费版', '{keyword}试用版', '{keyword}破解版', '{keyword}完整版',
      '{keyword}安卓版', '{keyword}iOS版', '{keyword}鸿蒙版', '{keyword}跨平台',
      '{keyword}Chrome插件', '{keyword}Firefox插件', '{keyword}Edge插件', '{keyword}Safari插件',
    ],
    state: [
      ...
      '{keyword}试用', '{keyword}演示', '{keyword}完整版', '{keyword}破解',
      '{keyword}安全吗', '{keyword}靠谱吗', '{keyword}值得吗', '{keyword}性价比',
      '{keyword}好用吗', '{keyword}难用吗', '{keyword}快吗', '{keyword}慢吗',
      '{keyword}简单', '{keyword}复杂', '{keyword}智能', '{keyword}自动化',
      '{keyword}稳定', '{keyword}可靠', '{keyword}强大', '{keyword}高效',
      '{keyword}安全', '{keyword}隐私', '{keyword}免费开源', '{keyword}付费专业',
    ],
    goal: [
      ...
      '{keyword}时间管理', '{keyword}任务规划', '{keyword}项目跟踪', '{keyword}日程安排',
      '{keyword}数据存储', '{keyword}文件共享', '{keyword}沟通交流', '{keyword}文档管理',
      '{keyword}创意设计', '{keyword}灵感激发', '{keyword}头脑风暴', '{keyword}决策分析',
      '{keyword}研究报告', '{keyword}数据分析', '{keyword}报表生成', '{keyword}知识整理',
      '{keyword}团队建设', '{keyword}客户服务', '{keyword}销售自动化', '{keyword}营销推广',
      '{keyword}品牌建设', '{keyword}用户增长', '{keyword}内容创作', '{keyword}流量获取',
    ],
    method: [
      ...
      '{keyword}安装教程', '{keyword}使用教程', '{keyword}配置教程', '{keyword}优化教程',
      '{keyword}常见问题', '{keyword}故障排除', '{keyword}最佳实践', '{keyword}案例分析',
      '{keyword}模板', '{keyword}快捷键', '{keyword}技巧', '{keyword}功能',
      '{keyword}对比', '{keyword}替代品', '{keyword}竞争对手', '{keyword}评测',
      '{keyword}大师课', '{keyword}速成班', '{keyword}训练营', '{keyword}认证',
      '{keyword}新手教程', '{keyword}进阶教程', '{keyword}高级教程', '{keyword}精通教程',
      '{keyword}视频教程', '{keyword}图文教程', '{keyword}实战案例', '{keyword}经验分享',
    ],
  },
  'zh-TW': {
    scenario: [
